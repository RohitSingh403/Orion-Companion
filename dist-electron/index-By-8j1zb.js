...
function requireFindMade() {
  ...
  const findMade = (opts, parent, path = void 0) => {
    if (path === parent)
  ...
  const findMadeSync = (opts, parent, path = void 0) => {
    if (path === parent)
      return void 0;
    try {
